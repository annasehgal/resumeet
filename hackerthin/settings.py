"""
Django settings for hackerthin project.
...
SECRET_KEY = 'django-insecure-iyqnua%9-r)wtk@o1ai0_#4e+3@-mm)q!59#ym%a7y_8vex_dg'
...
WSGI_APPLICATION = 'hackerthin.wsgi.application'
